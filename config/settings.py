...
ALLOWED_HOSTS = ['.skandage.com', 'skandage-app.onrender.com', 'localhost', '127.0.0.1', '192.168.1.166', 'benedict.skandage.com', '.yq-partners.com', 'onboarding.skandage.test', 'karna.localhost', '*']
